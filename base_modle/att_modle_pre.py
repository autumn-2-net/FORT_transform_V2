...
class Pcoross_attention(nn.Module):
...
class Pself_attention(nn.Module):
...
if __name__ == '__main__':
    ...
    bbb = Pcoross_attention(7, 512, 8, 512).cuda()
    dsds = bbb(img, bh)
    dsds

    bbbs = Pself_attention(7, 512, 8, 512).cuda()
    xdsdss = bbbs(img, )
    xdsdss
